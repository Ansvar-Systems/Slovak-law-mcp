...
**Endpoint:** `https://mcp.ansvar.eu/law-sk/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add slovak-law --transport http https://mcp.ansvar.eu/law-sk/mcp` |
...
```json
{
  "mcpServers": {
    "slovak-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-sk/mcp"
    }
  }
}
```
