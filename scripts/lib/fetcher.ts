/**
 * Rate-limited HTTP client for Slovak legislation from the Sejm ELI API.
 *
...
const USER_AGENT = 'Slovak-Law-MCP/1.0 (https://github.com/Ansvar-Systems/slovak-law-mcp; hello@ansvar.ai)';
